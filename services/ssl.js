...
export const initSSLPayment = async (orderId, ordersData, cartIDs) => {
  ...
  const paymentData = {
    ...
    currency: "BDT",
    tran_id: orderId,
    success_url: `http://localhost:3000/payment/ssl-success/${orderId}?cartIds=${encodedCartIds}`,
    fail_url: `http://localhost:3000/payment/ssl-fail/${orderId}`,
    cancel_url: `http://localhost:3000/payment/ssl-cancel/${orderId}`,
    ipn_url: `http://localhost:3000/payment/ssl-ipn?cartIds=${encodedCartIds}`,
